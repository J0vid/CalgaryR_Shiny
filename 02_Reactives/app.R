...
server <- function(input, output){
  ...
  nutrient_reactive <- reactive({
    #if you'd like to pause the calculation until you click an update button, swap the line of code above with: nutrient_reactive <- eventReactive(input$update_calculation, {
